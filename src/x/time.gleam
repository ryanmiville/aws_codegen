...
pub type DayTime {
  DayTime(hour: Int, minute: Int, second: Int, millisecod: Int)
}

pub fn to_parts(value: Time) -> #(Date, DayTime) {
  let #(#(year, month, day), #(hour, minute, second, millisecond)) =
    do_to_parts(value)
  #(Date(year, month, day), DayTime(hour, minute, second, millisecond))
}
